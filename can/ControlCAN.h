...
#define UINT64  unsigned long long //与minwindef.h不相同或未定义
#define CHAR    char //与minwindef.h不相同或未定义
#define DWORD   unsigned int //与minwindef.h不相同或未定义
#define PVOID   void * //与minwindef.h不相同或未定义
